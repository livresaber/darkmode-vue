...
const props = defineProps(['titleDark', 'titleLight', 'hiddenIcon', 'hiddenLabel'])
const textDark = props.titleDark ? props.titleDark : 'DarkMode'
const textLight = props.titleLight ? props.titleLight : 'LightMode'
</script>
